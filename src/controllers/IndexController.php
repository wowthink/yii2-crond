...
namespace wowthink\crond\controllers;

use Yii;
use wowthink\crond\models\Crontab;
use wowthink\crond\models\CrontabSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * IndexController implements the CRUD actions for Crontab model.
 */
class IndexController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->crontab_id]);
        }
